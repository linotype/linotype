<template>
  <div v-if="config.public.linotype.debug == 'true' || show == true" class="linotype-dump" :class="{ expend: expend }">
    <div class="title" @click="expend ? (expend = false) : (expend = true)">
      <strong>{{ title }}</strong>
    </div>
    <div class="content">
